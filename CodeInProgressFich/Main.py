...
quantity = 20                   #QUAntitée qu'on veux produire
...
if __name__ == "__main__":
    ...
    if models_proxy:
     ...
     #Production.getManufOrderToDo(models_proxy,['name', 'date_planned_start', 'product_id', 'product_qty', 'qty_producing', 'state'],10)                                                                                                 #Récupération des OF
